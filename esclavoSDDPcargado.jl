...
#Modelo de entrega 1 pero con muestreo mayor y cargado segun probabilidades
...
#PERDIDA DE CARGA-----------------------------------------------
VoLL=1200
function esclavoSDDPcargado(I_escenario, e_anterior, demanda, coef_cortes, pendiente_cortes, eb_result,num_itera,num_muestreo)
